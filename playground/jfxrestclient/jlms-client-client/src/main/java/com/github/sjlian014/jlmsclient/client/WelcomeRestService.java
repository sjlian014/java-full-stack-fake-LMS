package com.github.sjlian014.jlmsclient.client;

import com.github.sjlian014.jlmsclient.common.WelcomeMessage;
...
public class WelcomeRestService {
     ...
     * <p/>
     * By default the URL will point to 'http://localhost:8080/jlms-client-server' which should hit your
     ...
     *                  'http://localhost:8080/jlms-client-server'
     */
